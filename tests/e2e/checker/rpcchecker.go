...
// WithEventLimit sets the event limit for an RPCChecker. RPCChecker.Check sees more
...
func (rc *RPCChecker) CheckNamespace(connTimeout time.Duration, namespaces ...string) features.Func {
